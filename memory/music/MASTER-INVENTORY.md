# Master Song Inventory — Jeff Story (all projects, all eras)

The canonical list. Every song found across streaming, SoundCloud, Drive, setlists, and lyric docs. Cross-references versions, attribution, and status.

**Structure:** grouped by band/artist, within each by status (released → mixed → demo → sketch → lost). Duplicates consolidated.
...
Taylor Swift covers, pop-punk reinterpretations. aka "Trailer Swift" project.
...
### Solo singles
- **Thanksgiving** (Dec 2022) — Rock
- **Mom, You're the Bomb** (Dec 2022) — Alternative
- **Rockin Around the Christmas Tree** (Dec 2023) — cover
- **Oi To The World** (Dec 2024) — No Doubt/Vandals cover
- **Morgan the Wizard** (Jul 2025) — Punk

## Stalemate

### My Mom Says We're Cool (1997, re-released 2023) — album, 11 tracks
Apple ID `1718884118`
...
5. A New Girlfriend
6. I'm a Loser
7. My Mom Says We're Cool (title)
8. This Can't Be
9. Andrea (1997) — the namesake
10. Everyday
11. Wham Bam

### Stalemate singles
- **Andrea** (1998, re-dist 2023) — namesake track, 2 min
- **It's Been Only 18** (Nov 2023) — sequel callback to "Over 18"

## Something Dirty

### Whiskey and Lollipops EP (Mar 2003) — 5 tracks, explicit, Rock
Apple ID `1680727394` · DistroKid label 5164149
...
*Cover: spells "Whisky" — metadata uses "Whiskey"*

---

# 🎚 MIXED — complete but unreleased (biggest rediscovery opportunity)

## Stalemate — 2025-26 Recording Session (v1.4+ mixes)

Sitting in Drive, ready for release. Sean's paternity leave paused the drop.

1. **Turn Over The Flag** — v1.6 latest (most refined)
2. **The Way I Love You** — v1.4
3. **TBFH** — v1.5
4. **Manic** — v1.4
5. **Better Than Now** — v1.4
6. **Take The Step** — v1.4

All have SoundCloud v1.4 uploads from 4 months ago.

---

# 🎤 DEMOS — recorded, not final-mixed

## Rad Dad (2024 demos — band is cover-focused but has originals)
1. Thanksgiving Demo
2. Prevent the Fall Demo
3. Mom, You're The Bomb Demo
4. Run Away Demo
5. Less Miserable Demo
6. Going To New Mexico Demo

## Jeff Story solo demos (on SoundCloud, many from 2021–24)

- **Old You** v1.0 (13 plays) — became the v2.0 that got 12,337 plays (the hit)
- **Another Bland Love Song** Demo (189 plays)
- **Be With You** Demo (91 plays)
- **Mom You're The Bomb** Demo (85 plays)
- **Brave New World** Demo (40 plays)
- **Morgan The Wizard** Demo (32 plays)
- **Run Away** (23 plays)
- **It's Alright** Demo (19 plays)
- **Prevent the Fall** Demo (18 plays)
- **Unjustified** Demo (88 plays)
- **Times Have Changed** Demo (17 plays)
- **Grandma Got Run Over By A Reindeer** (25 plays)
- **MJ The Wizard** (15 plays) — distinct from Morgan

## Stalemate — older demos / practice versions
- **Morgan the Wizard v4.3** (Stalemate version — different from solo Morgan)
- Multiple practice tracks from 3-29-22 session: Drinking Song, Planet Of The Flakes, Everyday, Wham Bam, Velvet Roses (practice), Stand By Me, The Way I Love You, Going To Cali, Linoleum, Blind, Day In The Life
- **Jettison** — 14 yrs ago, 80 plays — 🔍 NOT on the album
- Stalemate - Andrea (Remastered) — 5 yrs ago
- Stalemate - Andrea (2023)

---

# 🎹 SKETCHES & WIPs (lyric + audio exists, not demo'd)

## Jeff Story solo
- **Hey There Andrea** (5 yrs, 59 plays) — 🔍 NAMESAKE SONG — a song about Andrea
- **Candi Lane / Candy Lane** — multiple versions across 5-11 years
- **Long Long Drive** (10-17-24 + 5 yrs + 6 yrs versions)
- **Take The Step** (v1.1, v1.4, plus newer solo 10-17-24 "Take The Step-Linoleum" mashup)
- **Be With You** (v2.5 + Demo + 10-24-24 + faster)
- **The Way I Love You** (v2.5 + solo 10yr + Stalemate 2026 v1.4)
- **I Need You** 8-22-24
- **The Leaves Are Weak** v1.0 (9 plays)
- **Oui C'est Fou** v1.4 (25 plays + 2 other plays on solo) — Jeff has a lyric video for this
- **90 Percent** v1.3 (5 plays) + 90 Percent (14 plays)
- **31 Timber View Ln** v1.0 (2 plays) — your old address?
- **The Prime Outline** v1.3 (2 plays)
- **Political Circus** v1.0
- **Annoying Me** (2020 era + 10-3-24 + 109 plays on main)
- **Less Miserable** (25 plays + 6 plays + 2 8-22-24)
- **Going To New Mexico** (223 plays + v1.4 faster + v1.5) — "Going to Cali" is probably an earlier title
- **Going to Cali** 3-23-23 (47 plays) + practice 3-23-23 (29 plays)
- **Dr Pepper / Disconnect** — 35 plays
- **Don't Look Bach** v1.3 (wordplay title)
- **August Heated Nights** — pirate song (lyric doc exists)
- **Brave New World** 8-31-23 capo 3 + Demo 40 plays + lyric doc
- **Highs and Lows** — multiple (58 plays + 10-17-24 + v2.0)
- **I'm Sorry I'm Crazy** (181 plays + v3.0 + 14 plays + v3.1)
- **Life At The Bottom** (137 plays + v2 + v3.0)
- **Synonyms For Stubborn** (19 plays)
- **Bottom Of My Heart** (6 plays)
- **A Simpler Life** (67 + 16 plays)
- **You Complete Me** (71 plays)
- **What To Do** (5 plays + 30 plays + instrumental HD)
- **Newfound Love** (76 + 11 + 3 plays across versions)
- **Home on the Lake** v1.2
- **Shine On Through The Darkness**
- **Dystopian Choice** (18 + solo version)
- **Head In The Sand** (75 plays)
- **TBFH** (77 + 39 plays across eras — precedes Stalemate 2025 version)
- **Independence Day** (multiple, 14 plays + v1.0)
- **Blindfolds** (67 plays)
- **Minor Lessons v2** (8 plays)
- **Everything's Beautiful** (190 plays)
- **Unjustified** (Demo 88 plays)
- **What does it mean** (7 plays)

## Stalemate (referenced in setlists or SC, no mix yet)
- **Drinking Song** (Am) — practice recordings exist, also played by Rad Dad
- **Be With You** (A)
- **Graveyard Swiftly** (E)
- **Don't Call Me A Hero** (F#)
- **Wham Bam** — album version + 4yr version + 8yr version
- **Everyday** — album + practice + 8yr version
- **Planet Of The Flakes** — album + practice + 8yr version
- **It's Only Been 18** — sketch reference
- **Long Long Drive** (Am) — live/practice version

## Something Dirty — beyond the Whiskey and Lollipops EP
Enough material for a second EP:
- **Rockstar** (259 plays, 14 yrs ago)
- **Mom** (259 plays, 14 yrs ago)
- **In The End** (48 plays + "In The End (Rhodes) v1.0")
- **Cigarettes In A** — multiple versions (39 + 29 practice + 78 + 'v6.9')
- **Blue Skies Fade** (40 plays, 6 yrs ago)
- **Bad Idea** (practice 2023, 64 plays)

---

# 📜 LYRIC-DOC / TITLE-ONLY (no recording surfaced)

From Drive lyric catalog + Stalemate songlist:

- **I Fall Down** (lyric doc)
- **B4L** (lyric doc + B4L Acoustic on SC, 10 yrs ago)
- **Story Of Us** (lyric doc — Trailer Swift parody, released)
- **Tooted Last Tuesday** / **I Tooted Last Tuesday** (235 plays — probably this is a song? Check)
- **Chains of Pain (Castle)**
- **Graveyard Shifty** — likely same as Graveyard Swiftly
- **Rabbit Hole** (Bb)

---

# 🎵 988 SUICIDE HOTLINE TRIO (sensitive content)

A three-song tribute from 2023, three "characters" calling 988:
- Dial 988 (Rancid) — 6 plays
- I Just Called 988 (Stevie) — 5 plays
- Call 988 (Jenny) — 5 plays

*Andrea notes: treat with care. Never auto-surface without Jeff's direction.*

---

# 🕹 COVERS & ARRANGEMENTS (Jeff-performed)

## 8-bit phase (2020–21)
Massive catalog of 8-bit (chiptune) arrangements. Jeff's signature creative thread of that era.

- **Blink 182** — I Won't Be Home For Christmas (22,124 plays!), Not Now (13,601 + instrumental 1,071), Enema of the State v1.1 (1,080), Wasting Time 8Bit (463), M&Ms (443), Asthenia (295)
- **Ramones** — Blitzkrieg Bop (307 + 402), I Wanna Be Sedated (323), Beat on the Brat (108 + 125), KKK Took My Baby Away (327)
- **Metallica** — One (717)
- **Lagwagon** — Change Despair 8Bit (713)
- **Sum 41** — Still Waiting (500), Pieces 8Bit (85)
- **All American Rejects** — Gives You Hell 8Bit (353)
- **Smashing Pumpkins** — Today (207)
- **Foo Fighters** — The Pretender (14)
- **Faith No More** — Easy (244)
- **Ben Folds** — The Luckiest (322)
- **Millencolin** — No Cigar 8Bit (176)
- **Nirvana** — Something In The Way 8Bit (127), In Bloom (71), On A Plain (38), Lithium (38)
- **Sublime** — Smoke Two Joints 8Bit (76)
- **NOFX** — Linoleum (133), Irrationality 8Bit (15), Olympia WA 8Bit with Rancid (83)
- **Anne-Marie** — 2002 8Bit (42)
- **Red Hot Chili Peppers** — Otherside 8Bit (56)
- **The Ataris** — In This Diary 8Bit (60)
- **Less Than Jake** — Automatic (51)
- **Rise Against** — Swing Life Away (40), Black Masks And Gasoline (186)
- **Tool** — Aenema (72)
- **Green Day** — Armitage Shanks (95), Dookie Medley (70)
- **No Use For A Name** — Chasing Rainbows 8Bit (25)
- **Vanessa Carlton** — A Thousand Miles 8Bit (96)
- **GNR** — Sweet Child Of Mine 8Bit (44)
- **Taylor Swift** — Shake It Off (132) — pre-Trailer Swift era
- **Beatles** — Abby Road Medley v1.0
- **Social Repose** — If You're Thinking Of Leaving (67)

## Christmas / holiday material
- O Holy Night (Family + original 8yr)
- Christmas Medley 2023
- Oi to the World (two versions)
- Holiday (No Drums + Holiday 8yr, 785 plays + Brand New Holiday 68 + Holiday 8 bit)
- Jingle Bell Rock v1.0 + v1.1
- Grandma Got Run Over (multiple versions)
- I Celebrate The Day (80 plays)
- Blink 182 - I Won't Be Home For Christmas (the 22,124 play monster)
- Rockin Around Christmas Tree (released single)

## Other covers (standalone, not 8-bit)
- Somewhere Over The Rainbow (51)
- Swing Life Away (40)
- Knocking on Heavens Door (224)
- Where the Sidewalk Ends (344)
- Greg Baldia - Eyes So Dry v1.1

## Rad Dad / Stalemate practice / jam sessions
- Practice 5-4-22 part 1 & 2 (12 plays each)
- Jammin June 7 2020 (24 plays)
- 6-28-2020 Jam1 (19) + Jam2 (24)
- Enema Of The State Live 9-12-2020 (17 plays)
- Multiple 3-29-22 practice tracks
- Multiple 3-23-23 practice tracks (Another Bland Love Song, Bad Idea, Cigarettes In A, Going To Cali, I Hate This Part, Rock Star, Disconnect)

---

# 📼 DEEP ARCHIVE — 8–14 years ago (lost-to-time candidates)

Jeff's time capsule. Titles alone hint at songs he may barely remember.

## 14 years ago (2011)
- Holiday (785 plays — a hit!)
- Wake up / Wake up bridge

## 12 years ago (2013)
- Parachute · Piano song · Madness · Genesis · I love mayhem (33) · No Noggin · Slow and sappy

## 11 years ago (2014)
- Piano ditty · Merry go round · Candy Lane · 10 Years Rough (4 plays) · Raw idea · Unknown

## 10 years ago (2015)
- Day in the life (4 plays) · Drinking song new (4 plays) · Velvet roses (1 play — separate from Something Dirty version) · B4L (Acoustic) · The way that i love you (35 plays, 10yr version) · War Drums of Tomorrow

## 9 years ago (2016)
- I Ain't Your Sweetheart v1.4 (211 plays) · Playin To Lose (27 plays) · Love Story v1.0 · Paramore v1.0 (34) · Do It Again v1.0 (47) · Kids Can't Fly v1.0 (38) · Sweetheart v1.0 (36) · Ain't your sweetheart · New song · New Hope Slow · Sunday morning · Sounds from Friday night

## 8 years ago (2017)
- Garage Ditty 1 & 2 · Ben Folds - The Luckiest · I Celebrate The Day · O Holy Night · Jingle Bell Rock (v1.0 + v1.1) · Grandma Got Runover (v1.0 + v1.1) · Greg Baldia - Eyes So Dry · Fall · Unknown 2 · Brand New Holiday (68 plays) · Old Stalemate album tracks re-uploaded

## 6 years ago (2019)
- New Act (5 + 17 plays) · Organized Chaos (6 + 1 plays) · Independence Day (5 + 0 plays) · Tomorrows Another Day (12 plays) · What to Do (30 plays) · What to Do Instrumental HD · Something Dirty - In The End (48 plays)

---

# 📊 ARCHIVE STATS

- **Total unique song titles catalogued:** ~180+
- **Released (any version on streaming):** 30 songs across 6 releases (3 albums + 10 singles including 5 EP tracks)
- **Mixed but unreleased:** 6 (the Stalemate 2025 session)
- **Demos recorded:** ~35
- **Sketches/WIPs:** ~60
- **Covers/arrangements:** ~50+
- **Deep-archive (8+ yrs old):** ~40 unique original titles
- **Biggest single track:** Old You v2.0 (12,337 plays)
- **Most-played cover:** Blink 182 - I Won't Be Home For Christmas (22,124 plays)

---

# 🎯 TOP REDISCOVERY CANDIDATES

Based on this inventory:

1. **The six mixed-but-unreleased Stalemate tracks** (biggest opportunity — literally ready to ship)
2. **Rad Dad 2024 demos** (6 songs never released on streaming)
3. **Hey There Andrea** (literal namesake song, only 59 plays — worth revisiting for the Andrea project)
4. **Jettison** (Stalemate outtake, not on the album — does a mix exist?)
5. **Something Dirty "second EP"** — Rockstar, Mom, In The End, Cigarettes In A, Blue Skies Fade (5 songs, full EP potential)
6. **Top of the 10+ year deep archive** — Holiday (785 plays from 2011), War Drums of Tomorrow (cryptic title), 10 Years Rough (what's this?)
